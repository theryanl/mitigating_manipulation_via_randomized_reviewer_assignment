...
""" This file runs multiple tests of the random nxn similarity matrices LP + bvn process. You can specify the runsizes using a for-loop like notation in the command line arguments. """
...
#looping over the sizes to test
    ...
    for i in range(num_trials):
        ...
        if TPMS_score != -1: # if feasible
            os.system("./a.out < rand_output.txt > rand_output_bvn.txt") #run the bvn part
